...
class IndexController extends ControllerBase {
    ...
    public function index(){
        $str = '
            <ul>
                <li><a href="/indicadores/XXXXX">[Em construção] Acervo das Bibliotecas da USP</a></li>
                ...
                <li><a href="/indicadores/XXXXX">[Em construção] Bases de Dados mantidas pelas Bibliotecas da USP</a></li>
                <li><a href="/indicadores/capacitacao">Capacitação de Usuários pelas Bibliotecas da USP - Completa</a></li>
                <li><a href="/indicadores/capacitacao_participantes">Capacitação de Usuários pelas Bibliotecas da USP - Nº de Participantes por Tipo de Capacitação</a></li>
                <li><a href="/indicadores/capacitacao_resumo">Capacitação de Usuários pelas Bibliotecas da USP - Resumo</a></li>
                <li><a href="/indicadores/XXXXX">[Em construção] Circulação do Acervo das Bibliotecas da USP</a></li>
                <li><a href="/indicadores/consultas_entre_bibliotecas">Consultas ao Acervo e Empréstimo entre Bibliotecas como Biblioteca Solicitante</a></li>
                <li><a href="/indicadores/estrutura_organizacional">Dados Administrativos - Estrutura Organizacional</a></li>
                <li><a href="/indicadores/XXXXX">[Em construção] Dados Administrativos - Horário de Funcionamento das Bibliotecas</a></li>
                <li><a href="/indicadores/XXXXX">[Em construção] Dados Administrativos - Informações Complementares</a></li>
                ...
                <li><a href="/indicadores/eventos_bibliotecas">Eventos Promovidos pelas Bibliotecas e com Participação das Bibliotecas</a></li>
                <li><a href="/indicadores/frequencia_bibliotecas">Frequência às Bibliotecas da USP, distribuída por Unidade</a></li>
                <li><a href="/indicadores/participacao_capacitacao">Participação das Equipes das Bibliotecas em Ações de Capacitação</a></li>
                <li><a href="/indicadores/projetos_bibliotecas">Projetos das Bibliotecas USP</a></li>
                <li><a href="/indicadores/XXXXX">[Em construção] Publicações Editadas pelas Bibliotecas</a></li>
                <li><a href="/indicadores/XXXXX">[Em construção] Publicações Oficiais Editadas pelas Unidades com a Participação das Bibliotecas</a></li>
